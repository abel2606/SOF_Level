...
public class PantallaContratos extends javax.swing.JFrame {
     ...
     */
    private void PantallaContratos(){
    ...
    private void OcultarDesplegarMenuOpciones() {
        if (menuVisible) {
            ...
            Dimension d=new Dimension(pnlContratos.getWidth() + pnlMenuOpciones.getWidth(), pnlContratos.getHeight());
            pnlContratos.setPreferredSize(d);
        } else {
        ...
        pnlContratos.revalidate();
        pnlContratos.repaint();
    }
